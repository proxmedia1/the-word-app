    ...
    <>
      ...
      <div className="app" data-theme="dark" ref={topRef}>
        ...
        <nav className="nav">
          ...
          <button className={`nav-btn${view==="reading"?" nav-active":""}`} onClick={()=>activeBook?setView("reading"):goHome()}>
          ...
          <button className={`nav-btn${view==="principles"?" nav-active":""}`} onClick={()=>activePrinciple?setView("principles"):goHome()}>
...
.app{min-height:100vh;background:var(--bg-0);color:var(--text-1);font-family:var(--font-body);font-size:15px;line-height:1.5;position:relative;overflow-x:hidden;-webkit-font-smoothing:antialiased;letter-spacing:-0.01em;}
